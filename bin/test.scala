...
println((River() - Health(50)).state.health == Health(949)) // Health(949)

val b = Block(0, River() + Energy(10), Nothing).put_on(Footman)
println((b.terrain.state.energy, b.creature.get.state.energy) == (Energy(0),Energy(60))) // (Energy(0),Energy(60))
...
println(map2.nearby(12, 2).map(_.index) == List(1, 2, 3, 5, 6, 7, 8, 10, 11, 12, 13, 14, 15, 16, 17, 18, 21, 22, 23))
...
println(map2.nearby(13, 2).map(_.index) == List(2, 3, 4, 6, 7, 8, 9, 11, 12, 13, 14, 16, 17, 18, 19, 22, 23, 24))
...
println(map2.nearby(1, 2).map(_.index) == List(0, 1, 2, 3, 5, 6, 7, 10, 11, 12))
...
println(Absorb(10) + Absorb(-10) == Absorb(0)) // Absorb(0)
println(Footman.affect(Footman) == (Ampify(0),Absorb(200))) // (Ampify(0),Absorb(200))
println(Footman.affect(River()) == (Ampify(-200),Absorb(0))) // (Ampify(-200),Absorb(0))
